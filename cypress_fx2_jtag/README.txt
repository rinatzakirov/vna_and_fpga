This is a fork of: http://sourceforge.net/p/ixo-jtag/code/HEAD/tree/usb_jtag/trunk/device/c51/
I modified it to compile with current SDCC, and added some additional features I need.
