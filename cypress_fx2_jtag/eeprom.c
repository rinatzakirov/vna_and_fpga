...
__xdata unsigned char eeprom[128];

extern __xdata char dscr_vidpidver[6];
extern __xdata char dscr_attrpow[2];
extern __xdata char dscr_usbver[2];
extern __xdata char dscr_strorder[4];
